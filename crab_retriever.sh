...
do
   echo "$sample"
crab getoutput -d crab_projects/crab_${date}_${sample}/

mkdir -p ~/public/HEEP_samples/crab_${date}_${sample}/

mv crab_projects/crab_${date}_${sample}/results/ ~/public/HEEP_samples/crab_${date}_${sample}/
hadd ~/public/HEEP_samples/crab_${date}_${sample}/outfile_${sample}.root ~/public/HEEP_samples/crab_${date}_${sample}/results/out*.root
done

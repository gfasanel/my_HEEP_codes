...
for regions in ['BB','BE','EE']:
    ...
    h_mee_trig[regions]             = hBase_mee.Clone('h_mee_trig_%s'%regions            )
    h_mee_trig_matchedGsf[regions]  = hBase_mee.Clone('h_mee_trig_matchedGsf_%s'%regions )
    h_mee_trig_matchedHEEP[regions] = hBase_mee.Clone('h_mee_trig_matchedHEEP_%s'%regions )
...
hBase_mee_mr1 = ROOT.TH1F('hBase_mee_mr1', '', 25, 0, 2500)
hBase_mee_mr2 = ROOT.TH1F('hBase_mee_mr2', '', 15, 2500, 5500)
hBase_mee_mr3 = ROOT.TH1F('hBase_mee_mr3', '', 1, 5500, 6000)
...
hBase_mee_mr.Write()
#This dummy histogram is used to decice the mass binning

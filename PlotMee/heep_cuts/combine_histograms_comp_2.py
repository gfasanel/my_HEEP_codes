...
##########################################################################################
sname50 = 'PHYS14_ZprimeToEE_M5000_40bx25'
...
file50_in = ROOT.TFile('histograms_ZprimeToEE_M5000_40bx25.root','READ')
...
for vname in var_names:
    for rname in regions:
        hRaw_50 = file50_in.Get('hraw_HEEP_cutflow50_25ns_total_%s_%s_%s'%( vname, sname50, rname))
        hNM1_50 = file50_in.Get('hNM1_HEEP_cutflow50_25ns_total_%s_%s_%s'%( vname, sname50, rname))
        ...
        legend_var.AddEntry(hRaw_50, '40bx25'       , 'f')#Raw distribution
        ...
        canvas_plots.Print('~/public/vars/heep_comp_4030_25_%s_%s.eps'%( vname, rname))
        canvas_plots.Print('~/public/vars/heep_comp_4030_25_%s_%s.png'%( vname, rname))
        canvas_plots.Print('~/public/vars/heep_comp_4030_25_%s_%s.pdf'%( vname, rname))
